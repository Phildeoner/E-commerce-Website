      ...
      <header className="p-4 bg-[#E7E3E4] dark:bg-gray-800 dark:text-gray-100">
        <div className="container flex justify-between items-center h-16 mx-auto">
          <a
            ...
            <img
              className="w-[260.091px] h-50px "
              src="https://s3-alpha-sig.figma.com/img/0c32/722b/55b2e3c3690f62046ec151febb87f64d?Expires=1703462400&Signature=Yie44HtTgJXsv8evFk3E8myBJn840RB14OF0VpZpA1JVLyV8c5af-vY63sXLWabFdGN4UOkzZHbXiZbuZSksIJuOltBIGybhtPAWjj9zS~Gjti0pTQeqozOEEiead7Vok~qRjdjj-S4przDQdE6trDpdWxN35nlrTLpRCpd2mFkhysj0s4ODHAVD~1g7kFH~DyVu9HQDsEAyaTENfTIrCdisUyA7U-IsACRqTCHcvHP1fgPxHWoGuBzNCDE3fiIQWWJKwP~vrzJEW8Ewv-svWZWjZkS8vqCUVFeQAOuhLd89tDHJEtYjHEK9TcQ-0~HWohEBAd3GqZ5Fs1E~9wClqg__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4"
              alt=""
            />
          </a>
          ...
          <div className="flex items-center ">
            <div className="relative">
              <input
                ...
                name="Search"
                placeholder="Search..."
                className="w-32 py-2 px-3 text-sm rounded-l-md sm:w-[30vw] focus:outline-none dark:bg-gray-800 dark:text-gray-100 focus:dark:bg-gray-900"
                data-ms-editor="true"
              />
            </div>
            <button
          ...
          <div className="flex items-center justify-between gap-12">
            <div className="relative">
              <select
                className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus: focus:border-gray-500"
                id="currency">
            ...
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md: dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li>
                <button
                  ...
                  className="flex items-center justify-between w-full py-2 px-3 text-gray-50 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-white md:dark:hover:text-blue-500 dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent">
                  Shop{" "}
                  <svg
